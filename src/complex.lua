...
-- Constants
local C_E        =  2.7182818284590452354
local C_PI       =  3.1415926535897932385
local C_HALF_PI  =  1.5707963267948966192
local C_TWO_PI   =  6.2831853071795864769 -- 2*Pi
local C_RAD      =  57.295779513082320877 -- 1 rad == 53 deg
local C_SQRT_TWO =  1.4142135623730950488 -- sqrt(2)
local C_PHI      =  1.6180339887498948482
local C_LOG2     =  0.6931471805599453094
